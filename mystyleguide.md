...
```css
--shadow-1: 4px 17px 28px -3px rgba(94, 94, 237, 0.47);
--shadow-2: 4px 17px 28px -3px rgba(31, 47, 86, 0.41);
```

box-shadow: 4px 17px 28px -3px rgba(94,94,237,0.47);
-webkit-box-shadow: 4px 17px 28px -3px rgba(94,94,237,0.47);
-moz-box-shadow: 4px 17px 28px -3px rgba(94,94,237,0.47);

box-shadow: 4px 17px 28px -3px rgba(31,47,86,0.41);
-webkit-box-shadow: 4px 17px 28px -3px rgba(31,47,86,0.41);
-moz-box-shadow: 4px 17px 28px -3px rgba(31,47,86,0.41);
